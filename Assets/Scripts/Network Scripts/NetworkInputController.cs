...
public class NetworkInputController : MonoBehaviour
{
    ...
    // New stuff
    // ================================================
    private RealtimeDrawableLine m_DrawableLine;
    private RealtimeDrawableArea m_DrawableArea;
    private RealtimeDrawableVolume m_DrawableVolume;
    private RealtimeDrawableSphere m_DrawableSphere;
    ...
    private NetworkPenInputController penInput;
    ...
    public void Dragged()
    {
        ...
        RealtimeDrawableShape drawableShape;
