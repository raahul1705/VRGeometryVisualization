...
public class NetworkLightUpOnCollision : MonoBehaviour
{
    ...
    private NetworkInputController mInputController;
    ...
    {
        NetworkInputController.Tool ct = mInputController.m_CurrentTool;
        return (ct == NetworkInputController.Tool.None) ||
            (ct == NetworkInputController.Tool.Area && gameObject.name.Contains("Line")) ||
            (ct == NetworkInputController.Tool.Volume && transform.parent.gameObject.name.Contains("Area")) ||
            (ct == NetworkInputController.Tool.Volume && gameObject.name.Contains("Mesh")) ||
            (ct == NetworkInputController.Tool.Mesh && gameObject.name.Contains("Sphere"));
    }
}
