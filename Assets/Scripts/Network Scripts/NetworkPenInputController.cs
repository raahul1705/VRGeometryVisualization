...
public class NetworkPenInputController : MonoBehaviour
{
    public NetworkInputController m_InputController;
    ...
    public void ButtonDown(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSource)
    {
        ...
        if (m_InputController.drawing != NetworkInputController.Tool.None) return; // don't switch tools if drawing
    ...
    private void SetTool(string toolName)
    {
        ...
        if (toolName.Contains("none"))
            m_InputController.SetTool(NetworkInputController.Tool.None);
        else if (toolName.Contains("line"))
            m_InputController.SetTool(NetworkInputController.Tool.Line);
        else if (toolName.Contains("area"))
            m_InputController.SetTool(NetworkInputController.Tool.Area);
        else if (toolName.Contains("cube"))
            m_InputController.SetTool(NetworkInputController.Tool.Volume);
        else if (toolName.Contains("sphere"))
            m_InputController.SetTool(NetworkInputController.Tool.Sphere);
        else if (toolName.Contains("mesh"))
            m_InputController.SetTool(NetworkInputController.Tool.Mesh);
    }
