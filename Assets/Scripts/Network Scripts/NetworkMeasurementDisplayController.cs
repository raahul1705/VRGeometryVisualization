...
public class NetworkMeasurementDisplayController : MonoBehaviour
{
    ...
    private NetworkInputController m_InputController;
    ...
    void Update()
    {
        if (m_InputController.m_CurrentTool == NetworkInputController.Tool.None && m_PointerController.collidingObject != null)
        {
